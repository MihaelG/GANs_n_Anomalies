...
FEATURES_CRITIC = 64
FEATURES_GEN = 64
CRITIC_ITERATIONS = 5 #discriminator/critic is 5 times more trained than generator
WEIGHT_CLIP = 0.01
...
writer_real = SummaryWriter(f"logs_glom/real")
writer_fake = SummaryWriter(f"logs_glom/fake")
step = 0
